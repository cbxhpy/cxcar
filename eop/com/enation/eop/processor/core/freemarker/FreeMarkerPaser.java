...
public final class FreeMarkerPaser {
	...
	public String proessPageContent() {
		...
		try {
			...
			FreeMarkerPaser.log.error("template" ,e);
	...
	public void setPageName(String pageName) {
		...
		if(clazz!=null)
		FreeMarkerPaser.log.debug(this.clazz.getSimpleName() +"set pageName ["+pageName+"]" );
	}
	...
	public void setPageFolder(String pageFolder) {
		...
		if(clazz!=null)
		FreeMarkerPaser.log.debug(this.clazz.getSimpleName() +"set folder ["+pageFolder+"]" );
	}
