...
<div class="headContent" style="">
	<div class="tableform mainHead" style="background:none repeat scroll 0 0 #EFEFEF;
		border-color:#DDDDDD #BEC6CE #BEC6CE #DDDDDD;
		border-style:solid;
		border-width:1px;
		margin:10px;
...
<div>
	<form enctype="multipart/form-data" method="post" id="uploadForm">
		...
		<div class="tableform" id="imgViewLocal" style="background:none repeat scroll 0 0 #EFEFEF;
			border-color:#DDDDDD #BEC6CE #BEC6CE #DDDDDD;
			border-style:solid;
			border-width:1px;
			margin:10px;
	...
	<div class="tableform" id="imgViewNet" style="display: none;background:none repeat scroll 0 0 #EFEFEF;
		border-color:#DDDDDD #BEC6CE #BEC6CE #DDDDDD;
		border-style:solid;
		border-width:1px;
		margin:10px;
