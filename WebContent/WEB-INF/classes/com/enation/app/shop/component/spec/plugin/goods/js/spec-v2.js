...
var SpecOper={
	...
	createSpecHead:function(specnames){
		...
		thead.append("<th  style='width: 200px;'>货号</th><th style='width: 150px;'>价格</th><th  style='width: auto;'>重量</th><th style='width: auto;'>成本价</th><th style='width: auto;'>产品简介(中文的；换行)</th><th style='width: auto;'>操作</th>");
	...
	createSpecBody : function(specAr, memPriceInput){
		...
		for(i in specAr){ 
			...
			td+='<td><textarea rows="4" cols="20" name="introduces" prop="introduce" prodid="'+propid+'">'+introduce+'</textarea></td>';
