...
public class TimeOutOrderPrint extends AutoRegisterPlugin implements IEveryDayExecuteEvent{
	...
	public void everyDay() {
		...
		List<Map> list= daoSupport.queryForList(sql,259200,DateUtil.getDatelineLong(),OrderStatus.ORDER_NOT_PAY,OrderStatus.ORDER_NOT_CONFIRM,1398873600);
		for (Map map:list) {
			orderFlowManager.cancel(Integer.parseInt(map.get("order_id").toString()), "订单72小时没有进行付款");
		}
	}
