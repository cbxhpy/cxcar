...
public interface IMemberStatisticsManager {
	 ...
	 * @return
	 */
	List<Map<String, Object>> getWashPrice(String startDate, String endDate);
	 ...
	 * @return
	 */
	List<Map<String, Object>> getRechargePrice(String startDate, String endDate);
	 ...
	 * @return
	 */
	List<Map<String, Object>> getYearWashPrice(String startDate, String endDate);
	 ...
	 * @return
	 */
	List<Map<String, Object>> getYearRechargePrice(String startDate,
			String endDate);
