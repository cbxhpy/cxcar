...
public class PrintTmplManager extends BaseSupport<PrintTmpl> implements
	...
	public PrintTmpl get(int prt_tmpl_id) {
		PrintTmpl printTmpl= this.baseDaoSupport.queryForObject("select * from print_tmpl where prt_tmpl_id = ?", PrintTmpl.class, prt_tmpl_id);
		String code=this.baseDaoSupport.queryForString("select code from logi_company where name='"+printTmpl.getPrt_tmpl_title()+"'");
	...
	public String replcePrintTmelHTML(String newTmpl_data) {
