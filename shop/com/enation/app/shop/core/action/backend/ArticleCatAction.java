...
@Action("articleCat")
@Results({
	@Result(name="cat_list", type="freemarker", location="/shop/admin/article/cat_list.html"),
	@Result(name="cat_add", type="freemarker", location="/shop/admin/article/cat_add.html"),
	@Result(name="cat_edit", type="freemarker", location="/shop/admin/article/cat_edit.html") 
})
