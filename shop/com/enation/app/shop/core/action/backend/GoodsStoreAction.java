...
public class GoodsStoreAction extends WWAction {
	...
	public String listGoodsStore(){
		goodsStoreList = this.depotManager.list();
	...
	public String getStoreDialogHtml() {
		try{
			...
			String str = StringUtil.isEmpty(e.getMessage()) ? "服务器出错" : e.getMessage();
			html = str;
		}
		return "dialog_html";		
	}
	...
	public String saveStock() {
		try {
			this.goodsStoreManager.saveStock(goodsid);
