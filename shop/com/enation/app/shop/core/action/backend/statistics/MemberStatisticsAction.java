...
@Results({ 
	...
	@Result(name = "recharge_price", type = "freemarker", location = "/shop/admin/statistics/member/recharge_price.html"),
	@Result(name = "wash_price", type = "freemarker", location = "/shop/admin/statistics/member/wash_price.html")
})
public class MemberStatisticsAction extends WWAction {
	 ...
	 * @return
	 */
	public String addRechargePriceHtml(){
	...
	public String getRechargePrice() {
		try {
			...
			if (start_date != null && !"".equals(start_date)) {
				startDateStamp = String.valueOf(DateUtil.getDatelineMs(start_date));
			}
			if (end_date != null && !"".equals(end_date)) {
				endDateStamp = String.valueOf(DateUtil.getDatelineMs(end_date));
			}
			
			//年模式数据
			if(type == 2){
				List<Map<String, Object>> list = this.memberStatisticsManager.getYearRechargePrice(startDateStamp, endDateStamp);
				...
				// 月模式数据
				List<Map<String, Object>> list = this.memberStatisticsManager.getRechargePrice(startDateStamp, endDateStamp);
	 ...
	 * @return result name
	 */
	public String addWashPriceHtml(){
		return "wash_price";
	}
	...
	public String getWashPrice() {
		try {
			...
			//年模式数据
			if(type == 2){
				List<Map<String, Object>> list = this.memberStatisticsManager.getYearWashPrice(startDateStamp, endDateStamp);
				...
				// 月模式数据
				List<Map<String, Object>> list = this.memberStatisticsManager.getWashPrice(startDateStamp, endDateStamp);
