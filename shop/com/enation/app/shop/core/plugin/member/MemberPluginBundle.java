...
public class MemberPluginBundle extends AutoRegisterPluginsBundle {
	...
	public void onLogout(Member member){
		try{
			...
			AutoRegisterPluginsBundle.loger.error("调用会员插件注销事件错误", e);
			throw e;
		}
	}
	...
	public void onLogin(Member member,Long upLogintime){
		try{
			...
			if(AutoRegisterPluginsBundle.loger.isErrorEnabled())
			AutoRegisterPluginsBundle.loger.error("调用会员插件登录事件错误", e);
			throw e;
		}
	}
	...
	public void onRegister(Member member){
		try{
			...
			if(AutoRegisterPluginsBundle.loger.isErrorEnabled())
			AutoRegisterPluginsBundle.loger.error("调用会员插件注册事件错误", e);
			throw e;
		}
	}
	...
	public void onEmailCheck(Member member){
		try{
			...
			if(AutoRegisterPluginsBundle.loger.isErrorEnabled())
			AutoRegisterPluginsBundle.loger.error("调用会员插件邮件验证事件错误", e);
			throw e;
		}
	}
	...
	public void onUpdatePassword(String password,int memberid){
		try{
			...
			if(AutoRegisterPluginsBundle.loger.isErrorEnabled())
				AutoRegisterPluginsBundle.loger.error("调用会员更新密码事件错误", e);
			throw e;
		}
	}
	...
	public  void onAddressAdd(MemberAddress address){
		try{
			...
			if(AutoRegisterPluginsBundle.loger.isErrorEnabled())
				AutoRegisterPluginsBundle.loger.error("调用会员添加地址事件错误", e);
			throw e;
		}
	}		
