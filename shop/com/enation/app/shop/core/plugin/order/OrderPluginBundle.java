...
public class OrderPluginBundle extends AutoRegisterPluginsBundle {
	...
	public void onBeforeCreate(Order order,List<CartItem>   itemList,String sessionid){
		try{
			...
			AutoRegisterPluginsBundle.loger.error("调用订单插件[Before创建]事件错误", e);
			throw e;
		}
	}
	public void onAfterCreate(Order order,List<CartItem>   itemList,String sessionid){
		try{
			...
			if(AutoRegisterPluginsBundle.loger.isErrorEnabled())
			AutoRegisterPluginsBundle.loger.error("调用订单插件[After创建]事件错误", e);
			throw e;
		}
	}
	...
	public void onFilter(Integer orderid,List<OrderItem> itemList){
		try{
			...
			if(AutoRegisterPluginsBundle.loger.isErrorEnabled())
			AutoRegisterPluginsBundle.loger.error("调用订单插件[filter]事件错误", e);
			throw e;
		}
	}	
	...
	public void onShip(Delivery delivery,List<DeliveryItem> itemList){
		try{
			...
			if(AutoRegisterPluginsBundle.loger.isErrorEnabled())
			AutoRegisterPluginsBundle.loger.error("调用订单插件[ship]事件错误", e);
			throw e;
		}
	}	
	...
	public void onItemShip(Order order,DeliveryItem deliveryItem,AllocationItem allocationItem){
		try{
			...
			if(AutoRegisterPluginsBundle.loger.isErrorEnabled())
			AutoRegisterPluginsBundle.loger.error("调用订单插件[onItemShip]事件错误", e);
			throw e;
		}
	}	
	...
	public void onReturned(Delivery delivery,List<DeliveryItem> itemList){
		try{
			...
			if(AutoRegisterPluginsBundle.loger.isErrorEnabled())
			AutoRegisterPluginsBundle.loger.error("调用订单插件[returned]事件错误", e);
	...
	public void onDelete(Integer[] orderId){
		try{
			...
			if(AutoRegisterPluginsBundle.loger.isErrorEnabled())
			AutoRegisterPluginsBundle.loger.error("调用订单插件[delete]事件错误", e);
			throw e;
		}
	}
	...
	public void onAllocationItem(AllocationItem allocationItem){
		try{
			...
			if (plugins != null) {
				...
				AutoRegisterPluginsBundle.loger.error("调用订单插件[onAllocationItem]事件错误", e);
	...
	public void onAllocation(Allocation allocation){
		try{
			...
			if (plugins != null) {
				...
				AutoRegisterPluginsBundle.loger.error("调用订单插件[onAllocation]事件错误", e);
...
/*	public String getAllocationViewHtml(OrderItem item){
	...
	public void filterAlloItem(int catid,Map values,ResultSet rs) throws SQLException{
		try{
			...
			if(AutoRegisterPluginsBundle.loger.isErrorEnabled())
			AutoRegisterPluginsBundle.loger.error("调用订单插件[filterAlloViewItem]事件错误", e);
			throw e;
		}
	...
	public String getAllocationHtml(OrderItem item){
		...
		try{
			...
			if(AutoRegisterPluginsBundle.loger.isErrorEnabled())
			AutoRegisterPluginsBundle.loger.error("调用订单插件[getAllocationHtml]事件错误", e);
	...
	public String getAllocationViewHtml(OrderItem item){
		...
		try{
			...
			if(AutoRegisterPluginsBundle.loger.isErrorEnabled())
			AutoRegisterPluginsBundle.loger.error("调用订单插件[getAllocationViewHtml]事件错误", e);
			throw e;
		}
	...
	public void onPay(Order order ,boolean isOnline){
		try{
			...
			if(AutoRegisterPluginsBundle.loger.isErrorEnabled())
			AutoRegisterPluginsBundle.loger.error("调用订单插件[pay]事件错误", e);
			throw e;
		}		
	}
	...
	public void onCanel(Order order){
		try{
			...
			if(AutoRegisterPluginsBundle.loger.isErrorEnabled())
			AutoRegisterPluginsBundle.loger.error("调用订单插件[canel]事件错误", e);
			throw e;
		}		
	}
	...
	public void onConfirmPay(Order order){
		try{
			...
			if(AutoRegisterPluginsBundle.loger.isErrorEnabled())
			AutoRegisterPluginsBundle.loger.error("调用订单插件[confirmPay]事件错误", e);
			throw e;
		}		
	}
	/**
	...
	public void onItemSave(Order order,OrderItem item){
		try{
			...
			AutoRegisterPluginsBundle.loger.error("调用订单插件[onItemSave]事件错误", e);
			throw e;
		}	
	}
