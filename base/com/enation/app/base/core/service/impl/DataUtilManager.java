...
import com.enation.app.base.core.service.IDataUtilManager;
import com.enation.eop.resource.model.Dictionary;
import com.enation.eop.sdk.database.BaseSupport;
import com.enation.framework.database.Page;
import com.enation.framework.util.StringUtil;

public class DataUtilManager extends BaseSupport<Dictionary> implements IDataUtilManager{
	...
	public List getDataList(String keyword) {
		String sql = " select dictionary_id, keyword, d_key, d_value, sort, intr from " + this.getTableName("dictionary") + " where keyword = ? order by sort ";
