...
//						sqlContent.append(app.dumpSql(setup));
				...
				//激发插件导出数据事件，获取插件用户数据
				String pluginData = dataExportPluginBundle.exportData();				
...
//				}
	...
	public DataExportPluginBundle getDataExportPluginBundle() {
		return dataExportPluginBundle;
	}

	public void setDataExportPluginBundle(
			DataExportPluginBundle dataExportPluginBundle) {
