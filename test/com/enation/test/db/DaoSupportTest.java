...
public class DaoSupportTest extends SpringTestSupport {
	...
	public void mytest() throws SQLException{
		JdbcTemplate jdbcTemplate = SpringTestSupport.getBean("jdbcTemplate");
	...
	public void beforeTest() {
		daoSupport= (IDaoSupport)SpringTestSupport.getBean("daoSupport");
		SpringTestSupport.jdbcTemplate.execute("drop table if exists enation_user;");
		SpringTestSupport.jdbcTemplate
	...
	private void assertInsert() {
		Map user_map = SpringTestSupport.jdbcTemplate
