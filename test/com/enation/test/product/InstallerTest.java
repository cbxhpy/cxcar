...
UserDTO userDTO = new UserDTO();
	...
	public void loadProfileTest(){
		...
		IProfileLoader loader = SpringTestSupport.getBean("profileLoader");
	...
	private void cleanMenu(){
		IUserService userService = UserServiceFactory.getUserService();
		String sql ="truncate table base_menu_"+ userService.getCurrentUserId() ;
		SpringTestSupport.jdbcTemplate.execute(sql);	
	}
	...
	public void installUriTest(){
		...
		IInstaller adminThemeInstaller =  SpringTestSupport.getBean("uriInstaller");
	...
	public void installThemeTest(){
		...
		IInstaller themeInstaller =  SpringTestSupport.getBean("themeInstaller");
	...
	public void installAdminThemeTest(){
		...
		IInstaller adminThemeInstaller =  SpringTestSupport.getBean("adminThemeInstaller");
	...
	public void installMenuTest(){
		...
		//安装菜单
		IInstaller menuInstaller =  SpringTestSupport.getBean("menuInstaller");
	...
	public void installWidgetTest(){
		...
		//安装挂件
		IInstaller menuInstaller =  SpringTestSupport.getBean("widgetInstaller");
	...
	private void menuInstallAssert(){
		...
		int count = SpringTestSupport.simpleJdbcTemplate.queryForInt(sql,userService.getCurrentSiteId());
