...
public class DlyCenterTest extends SpringTestSupport {
	...
	@Before
	public void mock(){
		this.dlyCenterManager = SpringTestSupport.getBean("dlyCenterManager");
	...
	private void clean(){
		...
		SpringTestSupport.jdbcTemplate.execute("drop table if exists js_dly_center_2");
//		shopSaasDBRouter.createTable(  "dly_center");
	...
	public void testDelete(){
		...
		int count  = SpringTestSupport.jdbcTemplate.queryForInt("select count(0) from js_dly_center_2 where disabled = 'false'");
