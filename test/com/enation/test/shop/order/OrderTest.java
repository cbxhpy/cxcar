...
public class OrderTest extends SpringTestSupport {
	...
	@Before
	public void mock(){
		orderManager= SpringTestSupport.getBean("orderManager");
		cartManager = SpringTestSupport.getBean("cartManager");
	...
	public void clean(){
		SpringTestSupport.jdbcTemplate.execute("drop table if exists js_order_2");
		SpringTestSupport.jdbcTemplate.execute("drop table if exists js_order_items_2");
		SpringTestSupport.jdbcTemplate.execute("drop table if exists js_order_gift_2");
		SpringTestSupport.jdbcTemplate.execute("drop table if exists js_order_log_2");
