...
public class PrintTmplTest extends SpringTestSupport {
	...
	@Before
	public void mock() {
		this.printTmplManager = SpringTestSupport.getBean("printTmplManager");
	...
	private void clean() {
		...
		SpringTestSupport.jdbcTemplate.execute("drop table if exists js_print_tmpl_2");
//		shopSaasDBRouter.createTable( "print_tmpl");
	...
	public void testDelete() {
		...
		int count = SpringTestSupport.jdbcTemplate
