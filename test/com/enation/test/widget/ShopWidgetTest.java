...
import com.enation.app.shop.core.plugin.goods.IGoodsBaseShowEvent;
...
public class ShopWidgetTest extends SpringTestSupport{
	...
	public void goodsDetailTest(){
		...
		IWidget detailWidget  = SpringTestSupport.getBean("goods_detail");
	...
	public void basePluginTest(){
		IGoodsBaseShowEvent baseShowEvent = SpringTestSupport.getBean("shopexGoodsBase");
	...
	public void memeberIndexTest(){
		IWidget detailWidget  = SpringTestSupport.getBean("member_order");
		//System.out.println(detailWidget.process(null));
	}
