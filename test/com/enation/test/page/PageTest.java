...
public class PageTest extends SpringTestSupport {
	...
	public void pageParserTest() {
		...
		IPageParser pagePaser = SpringTestSupport.getBean("facadePageParser");
		String content = pagePaser.parse(url);
	...
	public void updateTest() {
		...
		IPageUpdater pageUpdater = SpringTestSupport.getBean("facadePageUpdater");
